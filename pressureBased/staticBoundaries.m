...
% jet
% wantNames = [ ...
%                  "WEST_SOUTH_BACK", "EAST_SOUTH_BACK", ...
%                  "WEST_NORTH_BACK", "EAST_NORTH_BACK", ...
%                  ...
%                  "WEST_BACK", "EAST_BACK", ...
%                  "SOUTH_BACK", "NORTH_BACK", ...
%              ];
...
wantNames = [ ...
                 ...
                 "WEST_NORTH_BACK", "EAST_NORTH_BACK", ...
                 ...
                 "WEST_SOUTH", "EAST_SOUTH", ...
                 "WEST_BACK", "EAST_BACK", ...
                 "SOUTH_BACK", "SOUTH_FRONT", "NORTH_BACK"
             ];
...
function sol = solveStatic(Q, wS, Hxx, Hxy, Hxz, Hyy, Hyz, Hzz, Os, Is, as2, as4, omega, pI, mxyI, mxzI, myzI, solveShears)
    p = sym('p', 'real');
    ...
    if isstruct(S)
        ...
        if ~isfield(S, 'p') || isempty(S.p)
            error('solveStatic: no solution for p');
        end
...
function printAllMoments(sol19, sol27, phase_field)
    ...
    printMoment(0, 'p', sol19.p, sol27.p);
    ...
    sameShears = exprEqual(mxy19, mxy27) && exprEqual(mxz19, mxz27) && exprEqual(myz19, myz27);
    ...
    if sameShears
        ...
        fprintf('   {\n');
        printMoment(5, 'mxy', mxy19, mxy27, "19");
        printMoment(6, 'mxz', mxz19, mxz27, "19");
        printMoment(8, 'myz', myz19, myz27, "19");
        fprintf('   }\n');
        fprintf('   else\n');
        fprintf('   {\n');
        printMoment(5, 'mxy', mxy19, mxy27, "27");
        printMoment(6, 'mxz', mxz19, mxz27, "27");
        printMoment(8, 'myz', myz19, myz27, "27");
        fprintf('   }\n');
    end
